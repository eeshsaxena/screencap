...
on strings. The only intra-screencap imports are to sibling
``screencap.redaction`` backends (regex/secrets/pii/filters/resolver),
deferred inside ``create_default_pipeline``; this module is otherwise
standalone.
"""
...
def create_default_pipeline(
    ...
    from screencap.redaction.resolver import DetectionResolver as _Resolver
